...
static const char *fonts[]   	    = { "JetBrains Mono Medium:size=9:antialias=true:autohint=true", "JoyPixels:size=8:antialias=true:autohint=true" };
...
static const char col_border[]        = "#b34700";
